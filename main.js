...
function openQuickView(productId) {
    ...
    fetch(`https://rosybrown-ram-255793.hostingersite.com/un/api/products/${productId}`)
...
async function updateCartCount() {
    try {
        ...
        const response = await fetch(`https://rosybrown-ram-255793.hostingersite.com/un/cart/${userId}`);
        if (response.ok) {
