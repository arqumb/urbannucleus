...
function openQuickView(productId) {
    ...
    fetch(`https://urban-nucleus-production.up.railway.app/api/products/${productId}`)
...
async function updateCartCount() {
    try {
        ...
        const response = await fetch(`https://urban-nucleus-production.up.railway.app/cart/${userId}`);
        if (response.ok) {
